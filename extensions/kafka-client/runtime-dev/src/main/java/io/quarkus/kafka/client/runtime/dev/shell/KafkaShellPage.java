...
public class KafkaShellPage extends BaseExtensionPage {
    ...
    public boolean handleKey(int key, AppContext ctx) {
        ...
        if (viewMode == ViewMode.MESSAGE_DETAIL) {
            return handleMessageDetailKey(key, ctx);
        }

        // Handle messages view
        if (viewMode == ViewMode.MESSAGES) {
            return handleMessagesKey(key, ctx);
        }
    ...
    private boolean handleMessagesKey(int key, AppContext ctx) {
    ...
    private boolean handleMessageDetailKey(int key, AppContext ctx) {
    ...
    private static class TopicInfo {
        ...
        TopicInfo(String name, String topicId, int partitions, boolean internal, long messageCount) {
            this.name = name;
    ...
    private static class ConsumerGroupInfo {
        ...
        ConsumerGroupInfo(String name, String state, String coordinatorHost, String protocol, long lag) {
            this.name = name;
            this.state = state;
    ...
    private static class AclEntry {
        ...
        AclEntry(String operation, String principal, String permission, String pattern) {
    ...
    private static class MessageInfo {
        ...
        MessageInfo(int partition, long offset, String timestamp, String key, String value) {
