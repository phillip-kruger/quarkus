...
public class DevShellLauncher {
    ...
    public static void launch() {
        ...
        if (!(QuarkusConsole.INSTANCE instanceof AeshConsole)) {
            System.err.println("Dev Shell requires an ANSI-capable terminal");
            return;
        }
        ...
        if (connection == null) {
            System.err.println("Failed to start Dev Shell: No terminal connection available");
            return;
        }
        ...
        if (runtimeCL == null) {
            System.err.println("Failed to start Dev Shell: Runtime classloader not available");
        ...
        try {
            ...
            System.err.println("Failed to register Dev Shell launcher: " + e.getMessage());
            exitShellMode(aeshConsole, connection, inputQueue, outputQueue, runningFlag);
            return;
        }
