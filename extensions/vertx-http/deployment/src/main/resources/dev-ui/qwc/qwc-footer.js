...
export class QwcFooter extends LitElement {
  ...
  constructor() {
    ...
    this._tabItems = null;
    console.log("IN CONSTRUCTOR: Show = " + this.show + ", Height = " + this.height);
  }

  connectedCallback() {
    super.connectedCallback();
    console.log("IN CALLBACK: Show = " + this.show + ", Height = " + this.height);
  }
  ...
  _renderJsonRpcResponse(){
    if(this._tabItems){
      console.log("Show = " + this.show + ", Height = " + this.height);
      if(this.show){
        return html`
