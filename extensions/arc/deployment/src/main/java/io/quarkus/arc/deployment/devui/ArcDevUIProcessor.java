...
import io.quarkus.arc.runtime.devui.ArcDevUIService;
...
public class ArcDevUIProcessor {
    ...
    public void cardLinks(SynthesisFinishedBuildItem synthesisFinishedBuildItem,
        ...
        links.add(new CardLink.Builder(NAME)
                ...
                .label(String.valueOf(synthesisFinishedBuildItem.getBeans().size()))
                .build());

        links.add(new CardLink.Builder(NAME)
                .iconName("font-awesome-solid:eye")
                .component("qwc-arc-observers.js")
                .label(String.valueOf(synthesisFinishedBuildItem.getObservers().size()))
                .build());
    ...
    @BuildStep(onlyIf = IsDevelopment.class)
    public void jsonRPCService(BuildProducer<DevUIJsonRPCMethodBuildItem> devUIJsonRPCMethodProducer) {
        devUIJsonRPCMethodProducer.produce(new DevUIJsonRPCMethodBuildItem(NAME, ArcDevUIService.class));
    }
}
