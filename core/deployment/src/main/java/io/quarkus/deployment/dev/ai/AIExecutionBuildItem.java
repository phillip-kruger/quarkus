...
/**
 * TODO: Make this relevant, probably need to pass in a web component. ANd we probably do not need lable and method name
 */
public final class AIExecutionBuildItem extends MultiBuildItem {
    private final String label;
    private final String methodName;
    private final Optional<Pattern> filter;
    private final Function<Map<String, String>, ?> action;

    public AIExecutionBuildItem(String label, Function<Map<String, String>, ?> action, Optional<Pattern> filter) {
        this.label = label;
