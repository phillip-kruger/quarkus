...
When running in dev mode, Quarkus provides a dynamic, modular web interface accessible at http://localhost:8080/q/dev-ui. Below is a visual overview of the layout:
...
| Interactive entries that navigate to custom pages contributed by the extension.
